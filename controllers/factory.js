...
exports.getDocuments = (Model, populateOption = null) =>
...
exports.createDocument = (Model) =>
    catchAsync(async (req, res, next) => {
        ...
        if (req.files) {
            req.body.coverImage = `${req.protocol}://${req.get(
                'host'
            )}/images/products/${req.files.images[0].filename}`;
            const filenames = req.files.images.map(
                (file) =>
...
exports.getDocument = (Model, populateOption) =>
    catchAsync(async (req, res, next) => {
